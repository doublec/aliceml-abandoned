...
/* VOID:INT,INT,STRING (/dev/stdin:1) */
extern void g_cclosure_user_marshal_VOID__INT_INT_STRING (GClosure     *closure,
                                                          GValue       *return_value,
...
void
g_cclosure_user_marshal_VOID__INT_INT_STRING (GClosure     *closure,
                                              GValue       *return_value,
                                              guint         n_param_values,
                                              const GValue *param_values,
                                              gpointer      invocation_hint,
