...
type ('a,'b) token
type svalue
val KWAND:  'a * 'a -> (svalue,'a) token
val TO:  'a * 'a -> (svalue,'a) token
val ASSOCIATIVE:  'a * 'a -> (svalue,'a) token
val DEPENDENCY:  'a * 'a -> (svalue,'a) token
val WHERE:  'a * 'a -> (svalue,'a) token
val REDUCE:  'a * 'a -> (svalue,'a) token
val IN:  'a * 'a -> (svalue,'a) token
val COUNT:  'a * 'a -> (svalue,'a) token
val SEQUENTIAL:  'a * 'a -> (svalue,'a) token
