...
\emph{Inhalt.} Im Folgenden werden die Schnittstelle und GTK+ kurz vorgestellt.
...
eine 1:1-Abbildung der C-Bibliothek. Alice-Programme, die die Schnittstelle
...
\begin{figure}
\begin{picture}(100,100)\end{picture}
...
\cite{fudgets}. In jedem Fall ist eine solche funktionale Schnittstelle
...
\begin{thebibliography}{99}
  \bibitem{wwwgtkorg}http://www.gtk.org
  \bibitem{inspector}Bernadette Blum, Marvin Schiller:
                     Ein Browser f"ur Alice (Fopra), 2003\\
                     http://www.ps.uni-sb.de/~schiller/inspector.html
  \bibitem{fudgets}Magnus Carlsson, Thomas Hallgren:
                   Fudgets -- Purely Functional Processes with applications
                   to Graphical User Interfaces (PhD thesis), 1998\\
