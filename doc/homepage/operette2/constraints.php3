...
<?php heading("Stockhausen Operette 2 - Constraints", "constraints") ?>
...
<?php section("overview", "overview") ?>
  ...
  <P>
  <P>In particular, three modules are fairly complete:</P>
  ...
  <P>
    ...
    excellent <A href="http://www.mozart-oz.org/documentation/fdt/index.html">Mozart tutorial</A>.
  </P>
