...
<?php heading("Stockhausen Operette 2 - Packages", "packages") ?>
...
<?php section("limitations", "limitations") ?>
  ...
  <P>
    The package mechanism in Alice (as well as the Stockhausen
  ...
  <P>
    As an implementation limitation of Operette 2, the operational
