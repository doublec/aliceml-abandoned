...
<?php section("interface", "interface"); ?>
  ...
  <PRE>
	...
	val incl : FD.fd * fs -> unit
	val excl : FD.fd * fs -> unit
	val card : fs * FD.fd -> unit
	...
	structure Int :
	    sig
		val min : fs * FD.fd -> unit
		val max : fs * FD.fd -> unit
		val convex : fs -> unit
		val match : fs * FD.fd vector -> unit
		val minN : fs * FD.fd vector -> unit
		val maxN : fs * FD.fd vector -> unit
	    end
...
<?php section("description", "description"); ?>
  ...
  <DL>
    ...
    <DD>
      <P>returns <TT>true</TT> iff <I>x</I> denotes the empty set,
         <TT>false</TT> otherwise.
    </P></DD>
