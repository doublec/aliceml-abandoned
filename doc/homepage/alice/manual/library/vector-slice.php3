...
<?php heading("The VectorSlice structure", "The <TT>VectorSlice</TT> structure") ?>
...
<?php section("synopsis", "synopsis") ?>
  ...
  <P>
    ...
    <A href="http://SML.sourceforge.net/Basis/vector-slice.html"><TT>VectorSlice</TT></A> structure.
  </P>

  <P>See also:
    <A href="vector.php3"><TT>Vector</TT></A>,
    <A href="vector-pair.php3"><TT>VectorPair</TT></A>,
    <A href="array-slice.php3"><TT>ArraySlice</TT></A>,
...
<?php section("description", "description") ?>
  ...
  <DL>
    ...
    <DD>
      ...
      in reverse order. Equivalent to
      <TT>Vector.rev (toVector <I>sl</I>)</TT>.</P>
    </DD>
