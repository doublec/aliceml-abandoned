...
<?php section("synopsis", "synopsis"); ?>
  ...
  <P>
    Finite domain variables are variables whose values are sets of integers.
  </P>
  <P>
  ...
  <P>
    A propagator ceases to exist at least if all the variables
    ...
    <DD>
      ...
      <UL>
        <LI><TT>NAIVE</TT> considers only non-determined elements of <I>v</I>.
            ...
            a choice point for <TT>x = l</TT> and <TT>x <> l</TT> where <I>l</I>
            is the lower bound of <I>x</I>.
        <LI><TT>FIRSTFAIL</TT> considers only non-determined
            ...
            <TT>x <> l</TT> where <I>l</I> is the lower bound of <I>x</I>.
        <LI><TT>SPLIT</TT> considers only non-determined
            elements of <I>v</I>.
            Chooses the leftmost variable <I>x</I> in <I>v</I>,
            whose domain is minimal and creates
