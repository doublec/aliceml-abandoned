...
<?php section("synopsis", "synopsis") ?>
  ...
  <P>
    ...
    much like a <A href="promise.php3"><I>promise</I></A>, but is transparent
  ...
  <P>
    ...
    For most tasks, <A href="promise.php3"><TT>Promise</TT></A> is the
...
<?php section("description", "description") ?>
  ...
  <DL>
    ...
    <DD>
      ...
      <TT><I>h</I></TT> is not a hole, <TT>Hole</TT> is raised.</P>
    </DD>
    ...
    <DD>
      ...
      future itself, the future is failed with exception <TT>Future.Cyclic</TT>,
      the hole is filled with the same failed future,
      and the exception <TT>Future.Cyclic</TT> is raised.
