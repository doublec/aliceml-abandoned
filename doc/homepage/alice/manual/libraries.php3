...
<?php heading("Libraries", "libraries") ?>
...
<?php section("overview", "overview") ?>
  ...
  <P>
    Alice is equipped with parts of the
...
<?php section("toplevel", "top-level") ?>
  ...
  <P>
    ...
    in the <A href="usage.php3#interactive">interactive toplevel</A>.
  </P>
...
<?php section("fundamental", "fundamental") ?>
  ...
  <P>
    The so-called <I>fundamental</I> library of Alice
...
<?php section("system", "system") ?>
  ...
  <P>
    ...
    SML Basis Library.
    The Alice <A href="pickling.php3">pickling library</A> also
