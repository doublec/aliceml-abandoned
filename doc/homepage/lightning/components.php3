...
<?php section("execution", "execution") ?>
  ...
  <P><NOTE>
    Note 1: In the current prototype no signature matching is performed when
    a component is loaded. Thus component signatures may not change between
    compile time and runtime of dependent components, otherwise the system
    will ill-behave.
  </NOTE></P>
