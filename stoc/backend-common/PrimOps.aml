...
structure PrimOps :> PRIM_OPS =
	...
	val map =
		...
		ins ("General.exchange", SOME (Tuple 3));
		...
		ins ("String.sub", SOME (Tuple 2));
		ins ("String.substring", SOME (Tuple 3));
		...
		ins ("Word.+", SOME (Tuple 2));
		ins ("Word.-", SOME (Tuple 2));
		ins ("Word.*", SOME (Tuple 2));
		ins ("Word.div", SOME (Tuple 2));
		ins ("Word.mod", SOME (Tuple 2));
		ins ("Word.orb", SOME (Tuple 2));
		ins ("Word.xorb", SOME (Tuple 2));
		ins ("Word.andb", SOME (Tuple 2));
