...
$\exp$	&$:=$&	$\lit$				& literal expression \\
	...
	&&	$\f{new}\;\exp$			& constructor generation \\
	&&	$\longid$			& variable \\
...
E \vdash \f{new}\;\exp : t \Rightarrow t
}
\end{equation}
