...
//        runtimes("queens", times, 10);
  ...
  public static long runit(String name, int n) 
  {
    ...
    if (name.compareTo("fib")==0) {
      ...
      // System.out.println(ListClass.queens(n).length());
      ListClass.queens(n);
      ...
      System.out.println("usage: java Benchmarks <iterations> <name> <n>");      
    }
