...
<INITIAL>"let"    => (Tokens.MLKEY("let",yypos,yypos+3));
<INITIAL>"in"     => (Tokens.MLKEY("in",yypos,yypos+2));
<INITIAL>"end"    => (Tokens.MLKEY("end",yypos,yypos+3));
...
<INITIAL>"local"  => (Tokens.MLKEY("local",yypos,yypos+5));
...
<INITIAL>"<>"   => (Tokens.MLOP("<>",yypos,yypos+2));
<INITIAL>"'"   => (Tokens.MLOP("'",yypos,yypos+1));
<INITIAL>"_"   => (Tokens.MLOP("_",yypos,yypos+1));
<INITIAL>"<"    => (Tokens.MLOP("<",yypos,yypos+1));
<INITIAL>"<="   => (Tokens.MLOP("<=",yypos,yypos+2));
<INITIAL>">"    => (Tokens.MLOP(">",yypos,yypos+1));
<INITIAL>">="   => (Tokens.MLOP(">=",yypos,yypos+2));
